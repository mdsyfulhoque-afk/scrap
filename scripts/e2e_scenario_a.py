"""End-to-end Scenario A: Website -> Dataset."""
...
def main() -> None:
    ...
    print("=" * 60)
    print("STEP 2: CREATE DATASET SPECIFICATION")
    print("=" * 60)

    spec_dict = {
        "dataset": {"name": "e2e-test", "version": 1},
    ...
    specification = spec_manager.create_specification("e2e-test", spec_dict)
    ...
    print("=" * 60)
    print("STEP 3: RUN FEASIBILITY ANALYSIS")
    print("=" * 60)
    ...
    print("=" * 60)
    print("STEP 6: EXPORT DATASET")
    print("=" * 60)

    output_dir = "output/e2e-test"
    ...
    if stats_path.exists():
        ...
        print(f"Rejection reason counts: {stats.get('rejection_reason_counts', {})}")
